...
Сегодня исследуем взаимодействие процесса сборки пакетов с `stdenv.mkDerivation`.
...
> Начать изучение можно вот с коммита [6675f0a5](https://github.com/nixos/nixpkgs/tree/6675f0a52c0962042a1000c7f20e887d0d26ae25) в `nixpkgs`.
