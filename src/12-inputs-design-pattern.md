...
Теперь и `hello.nix` (оставленный читателю в качестве упражнения), и `graphviz.nix`б во-первых, не зависят от репозитория, а во вторых, настраиваются с помощью входных параметров.
