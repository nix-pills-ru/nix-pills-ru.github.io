...
В результате директории, содержащие побитово-идентичные файлы превращаются в побитово-неидентичные архивы, что приводит к различным хешам.
...
Базовый механизм использует хеши путей хранилища.
