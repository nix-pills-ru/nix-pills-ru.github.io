...
Синтаксис `nix repl` немного отличается от синтаксиса Nix, когда речь идёт о присваивании переменных (ведь в функциональных языках не бывает присваиваний).
Просто помните об этом, и вы не запутаетесь.
`nix repl` поможет нам быстрее вкатиться в язык, поскольку он оставляет простые вещи простыми.
