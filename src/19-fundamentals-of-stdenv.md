...
> Don\'t worry about the latter. It\'s empty, in fact.
...
> How can it be?
> The package must be referring to those other packages somehow. In fact, they are hardcoded in the `/setup` file:
